...
#define MEAS_LR     (*((volatile uint32_t *)(0x42000000 + (0x40024000 - 0x40000000)*32 + 4*4))) //PE4
#define MEAS_C      (*((volatile uint32_t *)(0x42000000 + (0x40005000 - 0x40000000)*32 + 5*4))) //PA5
#define HIGHSIDE_R  (*((volatile uint32_t *)(0x42000000 + (0x40007000 - 0x40000000)*32 + 2*4))) //PD2
#define LOWSIDE_R   (*((volatile uint32_t *)(0x42000000 + (0x40024000 - 0x40000000)*32 + 5*4))) //PE5
#define INTEGRATE   (*((volatile uint32_t *)(0x42000000 + (0x40024000 - 0x40000000)*32 + 1*4))) //PE1
